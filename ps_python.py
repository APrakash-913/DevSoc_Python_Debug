...
def read_data(filepaths):
    with open(filepaths, 'r') as json_file: # added 'r'
      data = json.load(json_file) 
    # Read data from filepaths
    return data
    # json_file.close() # need close file after use

data = read_data(filepaths)
print(data)
print("\n\n\n")
# print(data["AVENGERS"]["Thor"])
...
# returns info: Thor 
cipher_2 = get_oldest_avenger(data)
print(cipher_2)
print("\n\n\n")
...
cipher_3 = get_total_points(data)
print(cipher_3)
print("\n\n\n")
...
cipher_4 = get_more_than_average(data)
print(cipher_4)
print("\n\n\n")
...
def get_names(data):
    names=[]
    # more easy to use "append" function instead of insert (as we onlu want names)
    for i in data["AVENGERS"]:
